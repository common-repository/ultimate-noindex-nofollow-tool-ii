...
Text Domain: ultimate-noindex-nofollow-tool-ii
...
function unn_admin() {
	if($_POST['unn_hidden'] == 'Y') {
		// Verify nonce
		check_admin_referer( 'unn_admin_form');
...
?>
	...
	<div class="wrap">
		...
		<form name="unn_admin_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
			<?php wp_nonce_field( 'unn_admin_form' ); ?>
            ...
            <table>
                <tr>
                	<td colspan="2">
                        ...
                        <textarea name="unn_noindex_pages"><?php echo esc_textarea($noindex_pages); ?></textarea>
                    </td>
                </tr>
                <tr>
                	<td>&nbsp;</td>
                ...
                <tr>
                	<td colspan="2">
                        ...
                        <textarea name="unn_nofollow_pages"><?php echo esc_textarea($nofollow_pages); ?></textarea>
                    </td>
                </tr>
                <tr>
                	<td colspan="2">
